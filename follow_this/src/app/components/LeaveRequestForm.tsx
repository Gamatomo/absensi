...
export default function LeaveRequestForm({ student, onSubmit, requests }: LeaveRequestFormProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Ajukan permohonan izin tidak hadir
          </p>
        </div>
        <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="Acara Penting">Acara Penting</option>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Jelaskan detail alasan izin Anda..."
                  required
                />
              </div>
