...
export default function TeacherProfile({ teacher, onUpdate }: TeacherProfileProps) {
          ...
          <div className="p-8">
            {isEditing ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="block text-sm text-foreground">
                    Mata Pelajaran
                  </label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-secondary/30 rounded-lg border border-border">
                    ...
                    <div>
                      <p className="text-xs text-muted-foreground">ID Guru</p>
                      <p className="text-foreground">{teacher.id}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-secondary/30 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">{formatDate(teacher.enrolledDate)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-secondary/30 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">{teacher.phone || 'Belum diisi'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-secondary/30 rounded-lg border border-border md:col-span-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-foreground">{teacher.address || 'Belum diisi'}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3 p-4 bg-secondary/30 rounded-lg border border-border">
                      ...
                      <div>
                        ...
                        <p className="text-foreground">{teacher.faceId || 'Belum terdaftar'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-secondary/30 rounded-lg border border-border">
                      ...
                      <div>
                        ...
                        <p className="text-foreground">{teacher.cardId || 'Belum terdaftar'}</p>
                      </div>
                    </div>
                  </div>
                </div>
